...
from services.gateway.message_structuring.config import MessageStructuringConfig
...
from services.gateway.message_structuring.topic_backends.embedding import EmbeddingTopicBackend
